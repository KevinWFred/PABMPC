...
trainATBC=computeAUC()
#AUC: riskfactors vs combined p:0.000925262395383584
#AUC: marker vs combined p:0.21408555418329
#AUC: marker vs intercept (AUC 0.5) p:1.22277819129062e-11
#AUC: riskfactros vs intercept (AUC 0.5) p:8.36000798930748e-06
#AUC: combined vs intercept (AUC 0.5) p:3.06449498824958e-13
trainATBC$auc
# risk              maker            combine
# elsticnet  0.591(0.555,0.64) 0.638(0.595,0.675) 0.649(0.616,0.695)
# refit     0.591(0.558,0.639) 0.642(0.602,0.684)   0.657(0.617,0.7)
#Use PLCO as training
trainPLCO=computeAUC(traindat=PLCOdat,testdat=ATBCdat,prefix="PLCO")
#AUC: riskfactors vs combined p:0.0128706141848522
#AUC: marker vs combined p:0.309772127209568
#AUC: marker vs intercept (AUC 0.5) p:9.04013917297158e-08
#AUC: riskfactros vs intercept (AUC 0.5) p:0.00141086978512071
#AUC: combined vs intercept (AUC 0.5) p:4.72007795919903e-08
trainPLCO$auc
# risk              maker           combine
# elsticnet 0.564(0.526,0.611) 0.607(0.566,0.645) 0.611(0.58,0.655)
# refit      0.564(0.526,0.61)  0.58(0.539,0.619) 0.586(0.552,0.63)
#The results
#the weights from elastic net are stored in coeffs_min
save(trainATBC,trainPLCO,PLCOdat,ATBCdat,file="../result/elasticnet_2cohorts.RData")
